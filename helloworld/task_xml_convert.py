...
proxy_class = 'com.ytwl.cms.quartz.JobDetailBean'
data_source_str = 'dataSource'
quartz_properties_path = 'classpath:/ytwl-cms-admin-properties/quartz.properties'
job_factory_class = 'com.ytwl.cms.quartz.AutoWiringSpringBeanJobFactory'
